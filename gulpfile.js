...
const pathsStore = {
    styles: {
        styles: "styles/sass/**/",
        ext: "styles/sass/*/*.scss",
        sub: "styles/sass/*/*/*.scss",
        dest: "styles/css",
    },
};
...
gulp.task("getFiles", function (done) {    
    ...
    glob(pathsStore.styles.sub, function (er, files) {        
        filteredFiles = uniqValuesArray([
            ...files.map((file) => path.basename(file)),
        ]);
        done();
...
gulp.task("sass", function (done) {
    filteredFiles.forEach((file) => {
        ...
        const fileName = file;
        console.log(pathsStore.styles.styles + fileName)
...
gulp.task("watch", function () {
    gulp.watch([pathsStore.styles.ext, pathsStore.styles.sub]).on("change", function (fileName) {
